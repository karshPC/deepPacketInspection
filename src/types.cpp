...
// Helper: checks if domain is exactly `host`, or a subdomain of it
// (avoids false positives like "netflix.com" matching bare substring "x.com")
static bool matchesHost(const std::string& domain, const std::string& host) {
